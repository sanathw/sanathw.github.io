...
void processUI()
{
  if (bSanathBell != null && bSanathBell.doProcess == true) 
  {
    ...
    else if (experimentId == 9) experimentId = 0;
...
void updateUIState()
{
  ...
  else if (experimentId == 6) bSanathBell.txt = "Bell 3";
  else if (experimentId == 7) bSanathBell.txt = "Bell 4 - a";
  else if (experimentId == 8) bSanathBell.txt = "Bell 4 - b";
  else if (experimentId == 9) bSanathBell.txt = "Bell 5";
...
void createExperiment()
{
  ...
  else if (experimentId == 6) experiment = new Bell_3();
  else if (experimentId == 7) experiment = new Bell_4_a();
  else if (experimentId == 8) experiment = new Bell_4_b();
  else if (experimentId == 9) experiment = new Bell_5();
}
