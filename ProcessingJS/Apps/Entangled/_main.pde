...
void draw()
{
  ...
  translate(0, -60);
  fill(0, 100); 
  text(experiment.title, 0, 0);
  translate(0, 10);
  scale(0.4, 0.4);
  text("(Only some angels break Bell's Inequality.", 0, 0);
  translate(0,15);
  text("For classical you can't beaking any.)", 0, 0);
  translate(0,15);
  translate(0,15);
  text(experiment.angle1Text, 0, 0);
  translate(0,15);
  text(experiment.angle2Text, 0, 0);
  translate(0,15);
  text(experiment.angle3Text, 0, 0);
  translate(0,15);
  text(experiment.angle4Text, 0, 0);
  popMatrix();
...
class Bell_1_Web_a extends Experiment
{
...
class Bell_1_Web_b extends Experiment
{
  // VERSION 1 - 15% for Quantum
  /////////////////////////////
  // http://skepticsplay.blogspot.com.au/2009/03/bells-theorem-explained.html
...
class Bell_1_Web_c extends Experiment
{
...
class Bell_2_YouTube extends Experiment
{
...
class Bell_3_Book extends Experiment
{
  int count = 0;
  int ABclicks = 0;
  int BCclicks = 0;
...
class Bell_4_Jim_Al_Khalili_1 extends Experiment
{
// Evernote:
...
// 46:36
  ...
  Bell_4_Jim_Al_Khalili_1()
  { 
    title = "Jim Al-Khalili - 1";
    angle1Text = "A: 90";
    angle2Text = "B: 0";
    angle3Text = "C: 60";
    angle4Text = "";
...
class Bell_4_Jim_Al_Khalili_2 extends Experiment
{
// Evernote:
// https://www.evernote.com/shard/s3/nl/226168/614ce523-2101-435c-bdd3-2d815f2dc9c1
// Entanglement - Bell's Inequality
...
// 53:24
  ...
  Bell_4_Jim_Al_Khalili_2()
  {
    title = "Jim Al-Khalili - 2";
    angle1Text = "A0: 0";
    angle2Text = "A1: 115.7";
    angle3Text = "B0: 45";
    angle4Text = "B1: -22.9";
...
class Bell_5_Bell_Original extends Experiment
{
  int count = 0;
  int ABclicks = 0;
  int BCclicks = 0;
  ...
  Bell_5_Bell_Original()
  {
    title = "Bell's Original";
    angle1Text = "A: 0";
    angle2Text = "B: 45";
    angle3Text = "C: 90";
    angle4Text = "";
...
class Bell_6_Alain_Aspect extends Experiment
{
// Evernote:
// https://www.evernote.com/shard/s3/nl/226168/614ce523-2101-435c-bdd3-2d815f2dc9c1
// Entanglement - Bell's Inequality
// Alain Aspect
// https://www.youtube.com/watch?v=hZTPrlLVVYU
// Part 3 - From Bell's Inequalities to Entangled Qubits: A New Quantum Age?
// 5:14
  ...
  Bell_6_Alain_Aspect()
  {
    ...
    //anglesA = [0,        0,            (PI * 2 / 8), (PI * 2 / 8)];
    //anglesB = [(PI / 8), (PI * 3 / 8), (PI / 8),     (PI * 3 / 8)];
    anglesA = [0,        0,    ((PI /2)+(PI / 7)), ((PI /2)+(PI / 7))];
    anglesB = [(PI / 4), -0.4, (PI / 4),           -0.4];
  }
  ...
  void calculate(boolean aFire, boolean bFire) 
  {
    ...
    displayText2 = "Classical expect: < 2, Quantum expect: > 2";
    displayText3 = "" + f.toFixed(3);
    displayText4 = "Alain Aspect: https://www.youtube.com/watch?v=hZTPrlLVVYU  5:14";
    if (isClassicalQuantum == 1) showTick = true; else showTick = false;
  };
